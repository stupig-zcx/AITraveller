...
async function queryTestUser() {
  try {
    console.log('Attempting to query test user using fetch...');
    
    const response = await fetch('https://olsezvgkkwwpvbdkdusq.supabase.co/rest/v1/users?username=eq.testuser', {
      method: 'GET',
      headers: {
