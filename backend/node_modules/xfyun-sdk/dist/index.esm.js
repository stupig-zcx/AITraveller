...
var SpeechRecognizer = function (_a) {
    ...
    var _o = useState(''), recognitionText = _o[0], setRecognitionText = _o[1];
    var _p = useState('idle'), state = _p[0], setState = _p[1];
    var _q = useState(0), volume = _q[0], setVolume = _q[1];
    ...
    return (React.createElement("div", { style: styles.container, className: className },
        React.createElement("button", { style: getButtonStyle(), className: buttonClassName, onClick: handleButtonClick, disabled: state === 'connecting' || state === 'error' }, state === 'recording' ? buttonStopText : buttonStartText),
        showStatus && (React.createElement("div", { style: styles.status },
            "\u72B6\u6001: ",
            getStatusText())),
        showVolume && state === 'recording' && (React.createElement("div", { style: styles.volumeContainer },
            React.createElement("div", { style: styles.volumeBarContainer },
                React.createElement("div", { style: styles.volumeBar(getVolumeBarWidth()) })))),
        React.createElement("div", { style: styles.result }, recognitionText)));
};

export { SpeechRecognizer, XfyunASR, arrayBufferToBase64, calculateVolume, generateAuthUrl, parseXfyunResult };
